...
void LoadMapData()
{
	...
	{
		g_MapHandle[NORMAL_BLOCK] = LoadGraph("Data/Map/Block_2.png");
		g_MapHandle[ONE_WAY_BLOCK] = LoadGraph("Data/Map/One_Way_Block_2.png");
	}
	else
	{
		g_MapHandle[NORMAL_BLOCK] = LoadGraph("Data/Map/Block_3.png");
		g_MapHandle[ONE_WAY_BLOCK] = LoadGraph("Data/Map/One_Way_Block_3.png");
	}
